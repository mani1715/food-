...
export const MOCK_PRODUCTS: Product[] = [
  // Pickles
  {
    ...
    ingredients: ['Raw Raw Mangoes', 'Guntur Red Chili', 'Mustard Powder', 'Garlic', 'Cold-Pressed Sesame Oil', 'Sea Salt'],
    weightOptions: [
  ...
  },
  {
    ...
    description: 'Tender tender boneless chicken pieces fried crispy and marinated in hand-ground spice mix and lemon juice.',
  ...
  // Bakery
  {
    ...
    reviewsCount: 165,
    image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=800&auto=format&fit=crop',
    description: 'Oven-baked traditional Christmas plum cake packed with rum-soaked raisins, candied orange peel, and toasted walnuts.',
